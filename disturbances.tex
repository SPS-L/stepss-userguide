...
\begin{itemize}
	...
	\item IBL: do not force any Jacobian update; the bus and network Jacobians are left as the solver last set them
	\item NOT: do not override; the solver's own bus Jacobian flags are restored
\end{itemize}
