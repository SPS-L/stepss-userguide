...
\begin{quote}
\begin{tabbing}
\faHandPointRight ~ \= \rm An example of long record spanning over two lines: \\
\> \tt INJEC GFOL VSC1 A 1.0 1.0 0.0 0.0 0.005 0.15 1.02 1200.0 0.005 0.15 0.573 6.0 \\
\> \tt  0.0033 0.0333 10.0 0.002 -999.0 10.0 0.1667 50.0 0.10 0.4 0.5 1.0 -1000. -2000. 1.001 1 ;\\
\end{tabbing}
\end{quote} 
