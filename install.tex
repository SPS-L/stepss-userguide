...
The archive installs nothing beside itself and needs nothing installed for plotting: STEPSS draws its own curves, both while a simulation runs and afterwards. Earlier versions needed gnuplot here, by hand on Linux and macOS and bundled on Windows, and no longer do.
