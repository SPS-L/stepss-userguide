...
Using that GUI requires a 64-bit Java Runtime Environment (JRE), version~11 or later, installed on your computer. Any recent JRE or JDK is fine. To check if you have Java installed, and if so, which version it is:
\begin{enumerate}
