...
STEPSS is not restricted to Windows. RAMSES also builds on Linux and macOS with the GNU Fortran compiler, and stepss, the Python interface, is installed with {\tt pip} on both Windows and Linux. Those routes are documented online at\\
