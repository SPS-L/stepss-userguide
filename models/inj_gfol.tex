...
\begin{center}
{\large\bf GFOL: Grid-following VSC modelling in RAMSES}
\end{center}
...
{\bf Data.} The record has the following structure (default values
correspond to a 1200~MVA converter):
...
defaults above) disables the dynamic voltage support. Typical values of
